...
class MarkdownParser {
    ...
    parseBlockCode(parent, context) {
        let new_node = new Tree.BlockCode("" +
            "");
    ...
    addStyleToNode(style, parent) {
        ...
        if(last_children) {
            if(["strong", "cursive", "Image", "Header", "Image Lable", "Link",  "Code", "Reference Lable"].includes(last_children.type)) {
